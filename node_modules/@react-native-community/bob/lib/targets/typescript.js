...
async function build({
  ...
  try {
    ...
    if (await _fsExtra.default.pathExists(tsc)) {
      _crossSpawn.default.sync(tsc, ['--pretty', '--declaration', '--emitDeclarationOnly', '--project', project, '--outDir', output], {
        stdio: 'inherit'
      });

      await (0, _del.default)([_path.default.join(output, project.replace(/\.json$/, '.tsbuildinfo'))]);
